...
const Page = () => {
  ...
  const [data, setData] = useState({
    ...
    category: 'Startup',
    author: 'Alex Bennett',
    authorImg: '/assets/author_img.png', // ✅ Correct path
  });
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setData({
          ...
          category: 'Startup',
          author: 'Alex Bennett',
          authorImg: '/assets/author_img.png',
        });
        setImage(null);
  ...
  return (
    <form onSubmit={onSubmitHandler} className='pt-3 px-3 sm:pt-8 sm:pl-10'>
      ...
      <label htmlFor="image" className="cursor-pointer inline-block mt-2 transition hover:scale-105">
        <Image
          src={image ? URL.createObjectURL(image) : '/assets/upload_area.png'} // ✅ Correct fallback path
